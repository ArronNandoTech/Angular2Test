import { bootstrap } from '@angular/platform-browser-dynamic'; 2
...
@Component({
    ...
    <li class="item"><a href (click)="voteDown()">
...
@Component({ 
     ...
     directives:[ArticleComponent],
      template: ` <form class="ui large form segment"> 
       ...
       <input name="title" #newtitle></div> 
       <div class="field"><label for="link">Link:</label> 
